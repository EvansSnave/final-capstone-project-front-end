...
const CreateReservations = ({ id }) => {
  ...
  const doctorExist = (value) => {
    return doctors.some((doctor) => doctor.id === parseInt(value, 10));
  };
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="form-control">
        ...
        <input type="number" name="doctorId" {...register('doctorId', {
          required: 'Doctor id is required', min: { value: 1, message: 'Doctor id must be greater than 0' },
